...
public class ImageScrollView extends ScrollView implements OnTouchListener{
	...
	private static Handler handler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			ImageScrollView imageScrolView = (ImageScrollView) msg.obj;
			int scrollY = imageScrolView.getScrollY();
	...
	public void loadMoreImages() {
		...
		if (startIndex < DataController.Data().Size()) {
			Toast.makeText(getContext(), "正在加载...", Toast.LENGTH_SHORT).show();
			if (endIndex > DataController.Data().Size()) {
				endIndex = DataController.Data().Size();
			}
